@extends('layouts.app', ['page' => __('Teacher Management'), 'pageSlug' => 'teachers', 'pageParent' => 'Teacher'])
                    ...
                    <td class="text-right">
                        <div class="dropdown">
                          ...
                          <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                            <a class="dropdown-item" href="/teacher/{{ $teacher->id }}/edit">
                              <i class="fas fa-pencil-alt"></i> Edit
                            </a>
                            <a class="dropdown-item" href="#" data-toggle="modal" data-backdrop='static' data-keyboard="false" data-target="#exampleModalCenter_{{ $teacher->id }}" >
